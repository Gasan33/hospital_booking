...
class TFirebaseAuthException implements Exception {
  ...
  String get message {
    switch (code) {
      ...
      case 'user-not-found':
        return 'Invalid login details. User no found.';
      case 'wrong-password':
      ...
      case 'account-exists-with-different-credential':
        return 'An account already exists with the same email put different sign-in credential.';
      ...
      case 'app-not-authorized':
        return 'The app is not authorized to be use Firebase Authentication with the provided API key.';
      case 'keychain-error':
      ...
      case 'session-cookie-expired':
        return 'The Firebase session cookie has expired. Please sin in again.';
